...
* The Shiny application can be visualized at the link: [data science application](https://ahmedhamdi2072.shinyapps.io/coursera-data-science-capstone/)
...
* The final report comes from the link [Milestone Report](https://rpubs.com/ahmedhamdi2072/636558). 

* The next word prediction app is hosted on shinyapps.io: [Shiny app](https://ahmedhamdi2072.shinyapps.io/coursera-data-science-capstone/)



* The whole code of this application, as well as all the milestone report, related scripts, this presentation, etc. can be found in this GitHub repo: [GitHub](https://github.com/ahmedHamdy1994/data-science-project)
